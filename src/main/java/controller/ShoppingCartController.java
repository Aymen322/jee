...
public class ShoppingCartController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Here you can implement logic to add the pizza to the shopping cart
            // For example, you can store it in a session attribute representing the cart

            // Set pizza as a request attribute
            request.setAttribute("pizza", pizza);

            // Forward request to shoppingcart.jsp
