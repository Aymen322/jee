...
@WebServlet("/updateCommandStatusToReady")
public class UpdateCommandStatusToReadyController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect("CommandListController"); // Redirect to the command list page
