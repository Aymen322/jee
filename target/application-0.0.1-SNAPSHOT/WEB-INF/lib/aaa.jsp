    ...
    <div role="tabpanel" class="row our-menu-panel tab-pane fade in active show" role="tabpanel" id="data_all" aria-labelledby="all">
        ...
        <div class="col-xl-3 col-lg-3 col-md-4 text-center menu-box">
            <div class="menu-img">
                <a href="#">
                    <!-- Placeholder image -->
                    <img src="https://via.placeholder.com/150" alt="menu" class="menu-image">
                </a>
            </div>
            <a href="#" class="menu-title text-uppercase"><%=pizza.getName()%></a>
			...
			<div class="chef-banner owl-carousel wow fadeInUp">
				<div class="chef-outer text-center">
					<div class="chef-box">
						<div class="chef-hover">
							<img
								src="https://themes.templatescoder.com/pizzon/html/demo/1-2/02-Classic/images/chef-1.jpg"
				...
				<div class="chef-outer text-center">
					<div class="chef-box">
						<div class="chef-hover">
							<img
								src="https://themes.templatescoder.com/pizzon/html/demo/1-2/02-Classic/images/chef-2.jpg"
								alt="chef" class="chef-img">
						</div>
						<p class="chef-name text-uppercase fw-bold">John Doe</p>
						<span class="chef-ct">Sous Chef</span>
				...
				<div class="chef-outer text-center">
					<div class="chef-box">
						<div class="chef-hover">
							<img
								src="https://themes.templatescoder.com/pizzon/html/demo/1-2/02-Classic/images/chef-3.jpg"
								alt="chef" class="chef-img">
						</div>
						<p class="chef-name text-uppercase fw-bold">John Doe</p>
						<span class="chef-ct">Sous Chef</span>
				...
				<div class="chef-outer text-center">
					<div class="chef-box">
						<div class="chef-hover">
							<img
								src="https://themes.templatescoder.com/pizzon/html/demo/1-2/02-Classic/images/chef-4.jpg"
								alt="chef" class="chef-img">
						</div>
						<p class="chef-name text-uppercase fw-bold">John Doe</p>
						<span class="chef-ct">Sous Chef</span>
