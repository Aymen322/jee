				...
				<div class="row">
					<div class="col-xl-4 col-lg-4 col-md-4 footer-box">
						<div class="footer-logo">
							<a href="index.html">
								<img src="https://themes.templatescoder.com/pizzon/html/demo/1-2/02-Classic/images/footer-logo.png" alt="fooret-logo">
							</a>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 footer-box">
						<div class="useful-links">
							...
							<ul>
								...
								<li><a href="https://themes.templatescoder.com/pizzon/html/demo/1-2/02-Classic/about.html">About</a></li>
								<li><a href="https://themes.templatescoder.com/pizzon/html/demo/1-2/02-Classic/contact.html">Contact Us</a></li>
